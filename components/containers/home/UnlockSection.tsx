        ...
        <div className="row align-items-center gaper">
          <div className="col-12 col-lg-5 col-xxl-4">
            <div className="section__content">
              ...
              Harness the Winds of Knowledge and Data
              </h2>
              <p>
               AI paints a World where Machines Learn and Adapt, Unfurling a Tapestry of Innovation
               that Stretches Beyond the Horizon. We guide Organzations to Weave their Creations, 
               and Empowers them with Newfound Strengths.
              </p>
