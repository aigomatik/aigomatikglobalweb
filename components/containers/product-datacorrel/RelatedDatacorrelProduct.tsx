...
import { datacorrelRelatedProducts } from "@/public/data/datacorrel-related-products";

const RelatedDatacorrelProduct = () => {
  return (
    <section className="section h-s-case-alter fade-wrapper ">
      <div className="container">
        ...
        <div className="row gaper">
          {datacorrelRelatedProducts.slice(0, 4).map((item) => {
            return (
...
export default RelatedDatacorrelProduct;
