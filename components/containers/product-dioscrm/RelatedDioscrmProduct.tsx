...
import { dioscrmRelatedProducts } from "@/public/data/dioscrm-related-products";

const RelatedDioscrmProduct = () => {
  return (
    <section className="section h-s-case-alter fade-wrapper ">
      <div className="container">
        ...
        <div className="row gaper">
          {dioscrmRelatedProducts.slice(0, 4).map((item) => {
            return (
...
export default RelatedDioscrmProduct;
