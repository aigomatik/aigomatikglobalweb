                    ...
                    <div className="col-12 col-lg-10">
                      <div className="case-d-content-right sticky-item">
                        <div className="text-group slide-top">
                          ...
                          The Future of Client Management Begins Here
                          </h3>
                          <p>
                          Many CRM (Customer Relationship Management) applications doesnot work because of some prominent resons,
                          such as, user adaptibility, Inaccurate or incomplete data, Integrating CRM systems with other tools,
                          non customized to meet specific business needs and above all the costing and full ownership and vendor
                          unreliablity for support and updates.
                          </p>
                        </div>
                        <div className="text-group slide-top">
                          <h3 className="title-animation fw-6 text-white mt-12">
                          ...
                          <p>
                          Addressing these challenges requires a combination of proper planning, user training, integrating useful
                           updates and selecting the right CRM system by looking through the client&#39;s lenses results a best and 
                           cost effective solution.
                          </p>
                          <br/>
                          <p>
                           We at Aigomatik Global have researched over years and successfully build a CRM platform by amalgumating 
                           the latest software stacks with AI for tackling heavy tasks to overcome the choas of choosing a right platform for 
