                    ...
                    <div className="col-12 col-lg-10">
                      <div className="case-d-content-right sticky-item">
                        <div className="text-group slide-top">
                          ...
                          <p>
                          Welcome to www.aigomatikglobal.com/
                            </p>
                          <p>
                          These terms and conditions outline the rules and regulations for the use of Aigomatik Global 
                          LLP&#39;s Website, located at https://www.aigomatikglobal.com/.
                        </p>
                        <p>
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use 
                        www.aigomatikglobal.com/ if you do not agree to take all of the terms and conditions stated on this page.
                        ...
                        <div className="text-group slide-top">
                          ...
                          <p>We employ the use of cookies. By accessing www.aigomatikglobal.com/, you agreed to use cookies in agreement with the 
                            Aigomatik Global LLP&#39;s Privacy Policy.</p>
                        ...
                        <div className="text-group slide-top">
                          <div className="quote-group">
                            ...
                            <div className="content">
                              <q className="primary-text text-white">
                                ...
                                Creating terms and conditions for a specific website involves addressing various legal and 
                                operational aspects. Here&#39;s a basic template for terms and conditions related to an AI and Data Science website.
                              </q>
                            </div>
                          </div>
                          <div className="text-group slide-top">
                          ...
                          License
                            ...
                            <p>Republish material from www.aigomatikglobal.com/</p>
                            <p>Sell, rent or sub-license material from www.aigomatikglobal.com/</p>
                            <p>Reproduce, duplicate or copy material from www.aigomatikglobal.com/</p>
                            <p>Reproduce, duplicate or copy material from www.aigomatikglobal.com/</p>
                            <p>Redistribute content from www.aigomatikglobal.com/</p>
                            <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with
                                 the help of the Terms And Conditions Generator.</p>
                            <p>
                                Parts of this website offer an opportunity for users to post and exchange opinions and information
                                 in certain areas of the website. Aigomatik Global LLP does not filter, edit, publish or review 
                                 Comments prior to their presence on the website. Comments do not reflect the views and opinions 
                                 of Aigomatik Global LLP,its agents and/or affiliates. Comments reflect the views and opinions 
                                 of the person who post their views and opinions. To the extent permitted by applicable laws, 
                                 Aigomatik Global LLP shall not be liable for the Comments or for any liability, damages or 
                                 expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance 
                                 of the Comments on this website.
                            </p>
                            <p>
                            Aigomatik Global LLP reserves the right to monitor all Comments and to remove any Comments which can be 
                            ...
                            <p>
                            You hereby grant Aigomatik Global LLP a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit 
                        ...
                        <div className="text-group slide-top">
                          ...
                          <p>The following organizations may link to our Website without prior written approval:</p>
                            ...
                            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us 
                                ...
                                absence of Aigomatik Global LLP; and (d) the link is in the context of general resource information.</p>
                            ...
                            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you 
                                must inform us by sending an e-mail to Aigomatik Global LLP. Please include your name, your organization name, contact 
                                information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list
                                 ...
                                 <p>No use of Aigomatik Global LLP&#39;s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                        </div>
                        <div className="text-group slide-top">
                          <h3 className="title-animation fw-6 text-white mt-12">
                          iFrames
                        ...
                        <div className="text-group slide-top">
                          ...
                          <p>To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our 
                            website and the use of this website. Nothing in this disclaimer will:</p>
