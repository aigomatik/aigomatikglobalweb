...
import { attsenseRelatedProducts } from "@/public/data/attsense-related-products";

const RelatedAttsenseProduct = () => {
  return (
    <section className="section h-s-case-alter fade-wrapper ">
      <div className="container">
        ...
        <div className="row gaper">
          {attsenseRelatedProducts.slice(0, 4).map((item) => {
            return (
...
export default RelatedAttsenseProduct;
