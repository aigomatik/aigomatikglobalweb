...
export const starllmRelatedProducts = [
  {
    id: 1,
    title: "DIOS CRM",
    image: two,
    category: "design",
    link: "product-dioscrm",
    description:
  ...
  },
  {
    ...
    image: one,
    category: "logo",
    link: "product-attsense",
    description:
      "A Real-Time Gesture based Face Attendance System, Crafted to handle Face Detection within seconds using existing Camera setup.",
  },
  {
    id: 3,
    title: "DATA CORREL",
